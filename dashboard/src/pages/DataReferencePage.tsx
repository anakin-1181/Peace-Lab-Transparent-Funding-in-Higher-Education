  ...
  return (
    <div className="page-stack">
      <section className="panel reference-source">
        <h2>Data Source</h2>
        <p>
          This dashboard uses finance data published by <strong>HESA - Higher Education Statistics Agency</strong>.
        </p>
        <p>
          Source portal:{' '}
          <a href="https://www.hesa.ac.uk/data-and-analysis/finances" target="_blank" rel="noreferrer">
        ...
        <p>All values displayed in charts are taken from the provided files as reported (£000s), filtered to University College London (UKPRN 10007784).</p>
      </section>
